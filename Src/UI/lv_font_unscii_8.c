...
#if USE_LV_FONT_UNSCII_8 != 0	/*Can be enabled in lv_conf.h*/
...
static const uint8_t lv_font_unscii_8_glyph_bitmap[] = 
{
#if USE_LV_FONT_UNSCII_8 == 1
...
static const lv_font_glyph_dsc_t lv_font_unscii_8_glyph_dsc[] = 
{
#if USE_LV_FONT_UNSCII_8 == 1
...
lv_font_t lv_font_unscii_8 = 
{
    ...
    .glyph_bitmap = lv_font_unscii_8_glyph_bitmap,	/*Bitmap of glyphs*/
    .glyph_dsc = lv_font_unscii_8_glyph_dsc,		/*Description of glyphs*/
