...
#if USE_LV_FONT_UNSCII_8
LV_FONT_DECLARE(lv_font_unscii_8);
#endif

#if USE_LV_FONT_TENGXIANG_16
LV_FONT_DECLARE(lv_font_tengxiang_16);
#endif

#if USE_LV_FONT_YAHEI_12
LV_FONT_DECLARE(lv_font_yahei_12);
#endif

#if USE_LV_FONT_YAHEI_16
LV_FONT_DECLARE(lv_font_yahei_16);
#endif

#if USE_LV_FONT_YAHEI_20
LV_FONT_DECLARE(lv_font_yahei_20);
#endif

#if USE_LV_FONT_YAHEI_24
