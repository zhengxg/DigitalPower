...
#define USE_LV_FONT_UNSCII_8               0

#define USE_LV_FONT_TENGXIANG_16           0

#define USE_LV_FONT_YAHEI_12               1
#define USE_LV_FONT_YAHEI_16               1
#define USE_LV_FONT_YAHEI_20               1
#define USE_LV_FONT_YAHEI_24               1
...
#define LV_FONT_DEFAULT        &lv_font_yahei_16     /*Always set a default font from the built-in fonts*/
